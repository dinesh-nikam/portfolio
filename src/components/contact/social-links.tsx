...
export function SocialLinks() {
    ...
    return (
        <div className="mt-12 pt-12 border-t border-white/5">
            <h4 className="text-sm font-medium text-white/50 uppercase tracking-widest mb-6">Connect across the web</h4>
            <motion.div
                ...
                {socialLinks.map((social) => {
                    ...
                    return (
                        <motion.a
                            ...
                            className={`p-4 rounded-xl bg-white/5 border border-white/5 text-white/70 transition-all duration-300 group ${social.color}`}
