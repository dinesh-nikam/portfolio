                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-light text-white tracking-wide">
                            New <span className="text-white/40">Article</span>
                        </h1>
                    </div>
                </div>
                ...
                <div className="lg:col-span-2 flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                        ...
                        <input
                            ...
                            placeholder="e.g. Building Scalable APIs with Next.js"
                        />
                    </div>
                ...
                <div className="flex flex-col gap-6">
                    <div className="p-5 rounded-xl border border-white/10 bg-black/40 flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            />
                            <span className="text-[10px] text-white/30 font-mono">Will be auto-generated from title if left blank.</span>
                        </div>
                    ...
                    <div className="p-5 rounded-xl border border-white/10 bg-transparent flex flex-col gap-3">
                        <h3 className="text-xs uppercase font-mono text-white/50 tracking-wider">Quick Tips</h3>
                        <ul className="text-xs text-white/40 space-y-2 list-disc pl-4">
                            <li>Use `# Heading 1`, `## Heading 2` for sections.</li>
                            <li>Use \`\`\`tsx for code blocks with syntax highlighting.</li>
                            <li>Articles read best with small paragraphs.</li>
                        </ul>
                    </div>
                </div>
            </form>
